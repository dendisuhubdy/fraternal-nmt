...
class controlledMaskEmbeddedDropout(nn.Module):
    ...
    def forward(self, draw_mask, *args):
        #remember to use draw_mask=True after changing to training mode not to use previous zero mask used for evaluation
...
if __name__ == '__main__':
    ...
    embed_drop = controlledMaskEmbeddedDropout(f)
